...
export const hero: HeroContent = {
  ...
  image: {
    ...
    alt: "Свадебная фотосессия у воды в Санкт-Петербурге",
  },
};
...
export const contact: ContactContent = {
  ...
  text: "Свадьбы в Петербурге — от 55 000 ₽. Love Story, портреты и городские прогулки — от 18 000 ₽. Напишите в Telegram, и я предложу маршрут, тайминг и спокойный план съемки.",
  action: {
    label: "Telegram",
  ...
  image: {
    src: photo("ZlyChZVYM9lw85cRkOVVbrMIwImOVBju7YEtbuerTdBRS5eth_qWi3yvd8qszlz5B6ea57lbLgm_GRA4ZVDRXHMI.jpg"),
    alt: "Фотосессия у автомобиля в Санкт-Петербурге",
  },
};
